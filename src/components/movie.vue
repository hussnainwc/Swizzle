...
<template>
<div>
  <section v-center> <!-- Custom directive to center element -->
    <br>
    <br>
    <br>
    <br>
    <br>
    <!-- V-size to set element font size -->
    ...
    <br>
    <br>
    <!-- Conditional render only render when components parent path is not /soon -->
    <!-- V-color to change the color of the element -->
    <!-- Computed property attendance -->
    ...
    <br>
    <br>
    <!-- V-bind short hand syntax to get image and assign it to src -->
    <img class="poster" :src="getImage()" alt="Poster">
    <br>
    <br>
    <br>
    <br>
    <!-- V-if Conditional render if number of tickets is not empty -->
    ...
    <br>
    <br>
    <!-- Percent filter used as fall back to display random rating if any errors occur loading -->
    ...
    <br>
    <br>
    <!-- Conditonal render based on parent component path -->
    ...
    <div v-else-if="this.path == '/'" v-center>
      <!-- Conditonal class bind if path matches -->
